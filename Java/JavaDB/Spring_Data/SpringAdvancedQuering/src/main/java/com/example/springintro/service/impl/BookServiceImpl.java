...
public class BookServiceImpl implements BookService {
    ...
    @Override
    public List<String> findAllBookTitlesWhereTitleContainsStr(String containStr) {
        return bookRepository
    ...
    @Override
    public List<String> findAllTitlesWithAuthorLastNameStartsWith(String lastNameStarts) {
        return bookRepository
                .findAllByAuthor_LastNameStartsWith(lastNameStarts)
                .stream()
    ...
    @Override
    public int findAllBooksCountWithTitleLongerThan(int len) {

        return bookRepository
                .countOfBooksWithTitleLengthMoreThan(len);
    }

    @Override
    public List<String> findBookWithReducedInformationByGivenTitle(String bookTitle) {
        return bookRepository
