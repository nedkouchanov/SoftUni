...
public class PostServiceImpl implements PostService {
    ...
    public PostServiceImpl(ModelMapper modelMapper, PostRepository postRepository, UserService userService, PictureService pictureService, ValidationUtil validationUtil, XmlParser xmlParser) {
    ...
    public String importPosts() throws IOException, JAXBException {
        ...
        xmlParser.fromFile(POSTS_FILE_PATH, PostSeedRootDto.class).getPosts()
            ...
            sb.append(isValid ? String.format("Successfully imported Post, made by",
