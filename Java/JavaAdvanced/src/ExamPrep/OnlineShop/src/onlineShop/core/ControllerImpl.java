...
public class ControllerImpl implements Controller {
    ...
    public String addComputer(String computerType, int id,
        ...
        if (computerType.equals("DesktopComputer")) {
            computer = new DesktopComputer(id, manufacturer,
                    model, price);
        } else if (computerType.equals("Laptop")) {
            computer = new Laptop(id, manufacturer,
                    model, price);
        } else {
    ...
    public String addPeripheral(int computerId, int id,
        ...
        switch (peripheralType) {
            case "Headset":
                peripheral = new Headset(id, manufacturer, model,
                        price, overallPerformance, connectionType);
                break;
            case "Keyboard":
                peripheral = new Keyboard(id, manufacturer, model,
                        price, overallPerformance, connectionType);
                break;
            case "Monitor":
                peripheral = new Monitor(id, manufacturer, model
                        , price, overallPerformance, connectionType);
                break;
            case "Mouse":
                peripheral = new Mouse(id, manufacturer, model,
                        price, overallPerformance, connectionType);
                break;
            default:
    ...
    public String addComponent(int computerId, int id,
        ...
        return String.format(ADDED_COMPONENT, componentType,
                id, computerId);
    }
    ...
    public String BuyBestComputer(double budget) {
        ...
        List<Computer> filteredComputers = this.computers.
                values().
                stream().
