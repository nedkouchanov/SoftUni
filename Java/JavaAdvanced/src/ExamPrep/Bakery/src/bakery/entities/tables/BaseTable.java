...
public abstract class BaseTable implements Table {
    ...
    public double getBill() {
        double drinks = this.drinkOrders
                .stream().mapToDouble(Drink::getPrice).sum();
        double food = this.foodOrders
                .stream().mapToDouble(BakedFood::getPrice).sum();
        return drinks + food +
                (this.getNumberOfPeople() * this.getPricePerPerson());
    }
