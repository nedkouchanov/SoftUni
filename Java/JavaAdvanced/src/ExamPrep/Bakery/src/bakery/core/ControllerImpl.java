...
public class ControllerImpl implements Controller {
    ...
    public String addFood(String type, String name, double price) {
        BakedFood existing = this.foodRepository.getAll()
                .stream()
    ...
    public String addDrink(String type, String name, int portion, String brand) {
        Drink existing = this.drinkRepository.getAll()
                .stream()
    ...
    public String addTable(String type, int tableNumber, int capacity) {
        Table existing = tableRepository.getAll()
                .stream()
    ...
    public String reserveTable(int numberOfPeople) {
        Table freeTable = tableRepository.getAll()
                .stream()
    ...
    public String orderFood(int tableNumber, String foodName) {
        ...
        BakedFood food = this.foodRepository.getAll()
                .stream()
    ...
    public String orderDrink(int tableNumber, String drinkName, String drinkBrand) {
        ...
        Drink drink = this.drinkRepository.getAll()
                .stream()
    ...
    public String getFreeTablesInfo() {
        List<Table> freeTables = tableRepository.getAll()
                .stream()
